...
/**
 * Created by yaacovs on 31/12/2017.
 */

public class RecommendedFragment extends AllCatsFragment {
    ArrayList<DLCat> mItems;
    RecyclerView mRecyclerView;
    public static RecommendedFragment newInstance(int tabID, ArrayList<DLCat> items) {
        RecommendedFragment recommendedFragment = new RecommendedFragment();
        recommendedFragment.mItems = items;
        Bundle args = new Bundle();
        args.putInt("id", tabID);
        recommendedFragment.setArguments(args);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mRecyclerView.setAdapter(new DLCatAdapter(mItems,true));
    }
